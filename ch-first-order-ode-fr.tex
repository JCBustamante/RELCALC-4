...
nous voulons dire \emph{trouver la \myindex{primitive}}.
...
\pagebreak[0]
À l'aide du diagramme de phase, on peut classifier les points critiques comme stables ou instables\footnote{Parfois, on dira d'un point critique instable qu'il est \emph{semi-stable}\index{point critique semi-stable}, si une des deux flèches pointe vers le point critique.}.
...
\setcounter{exercise}{100}  %%%POURQUOI??
