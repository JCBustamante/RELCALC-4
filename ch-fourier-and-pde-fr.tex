...
Pour un autre exemple, si l'on a une corde à sauter qui tourne (alors $k=1$ lorsqu'elle sort \myquote{complètement}) et l'on tire sur les extrémités pour augmenter la tension, alors la vitesse augmente pour que la corde reste \myquote{sortie}.
