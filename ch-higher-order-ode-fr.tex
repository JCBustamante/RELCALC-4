...
Si l'on a une solution à une équation linéraire homogène de deuxième ordre, on peut en trouver une autre à l'aide de la méthode de  \emph{\myindex{réduction d'ordre}}.  L'idée\, étant donnée une solution $y_1$ à l'équation
...
\begin{exercise}
Faites l'\exerciseref{mv:ex1} pour
$m=3$, $k=12$ et $c=12$.
\end{exercise}
