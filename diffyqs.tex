...
%\input ch-intro.tex
\include{ch-intro-fr} %\input ch-intro-fr.tex


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% First order ODEs chapter
\include{ch-first-order-ode-fr}%\input ch-first-order-ode-fr.tex

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Higher order linear ODEs chapter
\include{ch-higher-order-ode-fr}%\input ch-higher-order-ode-fr.tex

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Systems of ODEs chapter
\include{ch-systems-fr}%\input ch-systems-fr.tex
...
\include{ch-fourier-and-pde-fr}%\input ch-fourier-and-pde-fr.tex
...
\include{ap-linear-algebra}%\input ap-linear-algebra.tex
