...
$\int f(x) \,dx + C$ comme ceci
\begin{equation*}
\int_{x_0}^x f(t) \,dt + C .
\end{equation*}
C'est le théorème fondamental du calcul qui nous permet ça.  C'est ce qui nous permet de dire  \emph{ \myindex{intégrer}} quand ce qu'on veut vraiment dire c'est 
